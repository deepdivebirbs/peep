 ...
 *
 * @author Dylan McDonald <dmcdonald21@cnm.edu>, modified by Daniel Juarez AKA "The god of Lightning and Thunder"
 **/
abstract class PeepTest extends TestCase {
use TestCaseTrait;
	...
	public final function getDataSet(): QueryDataSet {
		...
		$dataset->addTable("userProfile");
		$dataset->addTable("birdSpecies");
